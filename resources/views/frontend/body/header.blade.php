      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            @if((session("IS_BUYER"))=="yes")
            <li><a href="{{route('refer.earn.register')}}"><i class="icon fa fa-user"></i>
 Refer & Earn
            </a></li>
            @endif
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
         ...
         $setting = App\Models\SiteSetting::find(1);
          ...
          <!-- ============================================================= LOGO ============================================================= -->
          <div class="logo"> <a href="{{ url('/') }}"> <img style="height:60px; margin-top: -12px" src="{{ asset($setting->logo) }}" alt="logo"> </a> </div>
          <!-- /.logo --> 
          <!-- ============================================================= LOGO : END ============================================================= --> </div>
        <!-- /.logo-holder -->
            ...
            <form method="POST" action="{{route("product.search")}}">
              ...
              <div class="control-group">
                <ul class="categories-filter animate-dropdown">
                  <li class="dropdown"> <a class="dropdown-toggle"  data-toggle="dropdown" href="category.html">Pickup Centers <b class="caret"></b></a>
                    <ul class="dropdown-menu" role="menu" >
                      @php
                        $centers =  App\Models\Pickupcenter::get();
                      @endphp
                      @foreach ($centers as $item)
                      <li class="menu-header">{{$item->address}}</li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="#">{{$item->name}} ({{$item->phone}})</a></li>
                      @endforeach
...
<!--   // End Mini Cart Start with Ajax -->
  ...
  <li class="active dropdown yamm-fw"> <a href="{{ url('/') }}" class="link"><i class="fa fa-home icon-link" aria-hidden="true"></i><br>
...
<!--   // Get Category Table Data -->
 ...
 @foreach($categories as $category)
  <li class="dropdown yamm mega-menu"><a href="{{url("/")}}" class="link" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">
    <img class="icon-img" src="{{asset("$category->category_image")}}"><br>
...
{{ $subsubcategory->subsubcategory_name }} 
  ...
  @endforeach <!-- // End Category Foreach -->
     ...
     <li> <a href="{{route("shoppage")}}" class="link">    <img style="max-width:51px" class="icon-img" src="{{asset("upload/category/shop.png")}}"><br>Shop</a> </li>
