...
<div class="body-content outer-top-xs" id="top-banner-and-menu">
  ...
  <div class="container">
    ...
    <div class="row main-bar" id="main-bar">
      <!-- ============================================== SIDEBAR ============================================== -->
                      ...
                      <div class="row product-micro-row">
                        ...
                        <div class="col col-xs-7">
                          <div class="product-info">
                            ...
                            <div class="product-price"> <span class="price"> INR{{ $product->selling_price }} </span>
                            </div>
                            <!-- /.product-price -->
                    ...
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          ...
                          @else
                          <div class="product-price"> <span class="price"> INR {{ $product->discount_price }} </span>
                            <span class="price-before-discount">INR {{ $product->selling_price }}</span> </div>
                          @endif
              ...
              <div class="products">
                <div class="product">
                  ...
                  <div class="product-info text-left">
                    ...
                    @else
                    <div class="product-price"> <span class="price"> INR{{ $product->discount_price }} </span> <span
                        class="price-before-discount">INR {{ $product->selling_price }}</span> </div>
                    @endif
