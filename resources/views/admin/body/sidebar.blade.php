<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @if ($admin[0]->categories == 1)
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{ route('all.subcategory') }}"><i class="ti-more"></i>Sub Category</a>
                        </li>
                        <li><a href="{{ route('all.subsubcategory') }}"><i class="ti-more"></i>Sub Sub
                                Category</a></li>
                    </ul>
                </li>
            @else
            ...
            @endif
            <li>
                <a href="{{ route('pickupcenter.view') }}">
            ...
            @if ($admin[0]->products == 1)
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{ route('stock.product') }}"><i class="ti-more"></i>Product Stock</a>
                        </li>
                    </ul>
                </li>
            @else
    ...
    <div class="sidebar-footer">
        <!-- item-->
        <a href="{{ route('setting.site') }}" class="link" data-toggle="tooltip" title=""
